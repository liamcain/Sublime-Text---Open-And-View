...
When you hit Shift+Command+m this plugin will check the top 10 lines of the current file look for the location tag and append it to the URL defined below
...
If the programming language uses a different identifier for comments, simply change // to whatever. I have it setup for PHP.
